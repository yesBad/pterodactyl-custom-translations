...
export default () => {
    ...
    return (
        <div css={tw`mt-4 grid grid-cols-1 sm:grid-cols-2 gap-4`}>
            <TitledGreyBox title={lang.memory_usage} icon={faMemory}>
                {status !== 'offline' ?
                    <canvas
                        id={'memory_chart'}
                        ref={memoryRef}
            ...
            <TitledGreyBox title={lang.cpu_usage} icon={faMicrochip}>
                {status !== 'offline' ?
            ...
            <TitledGreyBox title={lang.inbounddata} icon={faEthernet}>
                {status !== 'offline' ?
            ...
            <TitledGreyBox title={lang.outbounddata} icon={faEthernet}>
                {status !== 'offline' ?
